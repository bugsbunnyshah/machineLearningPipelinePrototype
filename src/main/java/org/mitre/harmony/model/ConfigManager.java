...
public class ConfigManager
{
	...
	{	
		...
		try {
			...
			InputStream configStream = new FileInputStream(new File("org.mitre.harmony.config.xml"));
	...
	{
		File configFile = new File("org.mitre.harmony.config.xml");
		File tempConfigFile = new File(configFile.getParentFile(),"org.mitre.harmony.config.xml.tmp");
		try {
