...
public class TalismanMDS implements IMultiDimScaler<Integer> {
	...
	/* (non-Javadoc)
	 * @see org.mitre.org.mitre.affinity.dimensionality_reducers.IMultiDimScaler#scaleDimensions(org.mitre.org.mitre.affinity.clusters.DistanceGrid, boolean, boolean, int, boolean)
	 */
