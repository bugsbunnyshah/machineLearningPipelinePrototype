 ...
 * created Feb 27, 2009
 */
public class CosineDistanceFunction implements DistanceFunction<Integer, Schema> {
	 ...
	 */
	   public static double cosineDoc(SchemaTermVector R1, SchemaTermVector R2){
		      ...
		      v1size = Math.sqrt(v1size);
		      v2size = Math.sqrt(v2size);
	 ...
	 //helper, inefficient.
	   private static void prettyPrint(ArrayList<Integer> schemaIDs, DistanceGrid<Integer> dg, AffinitySchemaManager schemaManager){
	   ...
	   public static void main(String[] args){
		   ...
		   DistanceGrid<Integer> dg = jdf.generateDistanceGrid(schemaIDs, schemaManager);
