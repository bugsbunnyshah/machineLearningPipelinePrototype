...
/**
 * An implementation of a cluster object GUI that displays the cluster object as an oval.
 * 
 * @author CBONACETO
 *
 */
public class OvalClusterObjectGUI<K extends Comparable<K>, V> extends BasicClusterObjectGUI<K, V> {
	...
	public OvalClusterObjectGUI(Shell parent, K objectID) {
		this(parent, objectID, 10, 10);
	}
	
	public OvalClusterObjectGUI(Shell parent, K objectID, int width, int height) {
	...
	/* (non-Javadoc)
	 * @see org.mitre.org.mitre.affinity.view.swt.ISchemaGUI#containsPoint(int, int)
	 */
