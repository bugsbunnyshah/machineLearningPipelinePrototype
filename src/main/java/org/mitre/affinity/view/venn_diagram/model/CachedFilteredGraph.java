...
//import org.mitre.org.mitre.schemastore.model.graph.FilteredGraph;
import org.mitre.schemastore.model.schemaInfo.FilteredSchemaInfo;
//import org.mitre.org.mitre.schemastore.model.graph.HierarchicalGraph;
 ...
 *
 */
//public class CachedFilteredGraph extends FilteredGraph {
public class CachedFilteredGraph extends FilteredSchemaInfo {
	private static final long serialVersionUID = 1L;
	
	protected ArrayList<SchemaElement> cachedFilteredElements = null;

	//public CachedFilteredGraph(HierarchicalGraph graph) {
	public CachedFilteredGraph(HierarchicalSchemaInfo graph) {
		super(graph);
	}
